...
//klasaThings
const PermissionLevels = require("./klasaThings/permissionLevel");
const defaultClientSchema = require("./klasaThings/defaultClientSchema");

class OmniClient extends Client {
  constructor(options) {
    super({...options, PermissionLevels, defaultClientSchema});
    this.config = config;
    //OmniFetch
